...
上一篇文章 [几道智力题](../gao-pin-mian-shi-xi-lie/yi-hang-dai-ma-jie-jue-de-zhi-li-ti.md) 中讨论到一个有趣的「石头游戏」，通过题目的限制条件，这个游戏是先手必胜的。但是智力题终究是智力题，真正的算法问题肯定不会是投机取巧能搞定的。所以，本文就借石头游戏来讲讲「假设两个人都足够聪明，最后谁会获胜」这一类问题该如何用动态规划算法解决。
...
[上一篇：动态规划之子序列问题解题模板](zi-xu-lie-wen-ti-mo-ban.md)

[下一篇：贪心算法之区间调度问题](tan-xin-suan-fa-zhi-qu-jian-tiao-du-wen-ti.md)
