...
![title](../.gitbook/assets/title%20%2819%29.png)
...
可以看到，我们是通过保留 pattern 中的「\*」，同时向后推移 text，来实现「_」将字符重复匹配多次的功能。举个简单的例子就能理解这个逻辑了。假设 \`pattern = a_`,`text = aaa\`，画个图看看匹配过程：

![example](../.gitbook/assets/example.png)
...
[上一篇：动态规划之四键键盘](dong-tai-gui-hua-zhi-si-jian-jian-pan.md)

[下一篇：最长公共子序列](zui-chang-gong-gong-zi-xu-lie.md)
