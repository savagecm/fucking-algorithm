...
很多读者反应，就算看了前文[动态规划详解](dong-tai-gui-hua-xiang-jie-jin-jie.md)，了解了动态规划的套路，也不会写状态转移方程，没有思路，怎么办？本文就借助「最长递增子序列」来讲一种设计动态规划的通用技巧：数学归纳思想。
...
PS：旧文[二分查找算法详解](../suan-fa-si-wei-xi-lie/er-fen-cha-zhao-xiang-jie.md)详细介绍了二分查找的细节及变体，这里就完美应用上了。如果没读过强烈建议阅读。
...
[上一篇：动态规划答疑篇](zui-you-zi-jie-gou.md)

[下一篇：编辑距离](bian-ji-ju-li.md)
