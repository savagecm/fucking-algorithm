...
二分查找本身不难理解，难在巧妙地运用二分查找技巧。对于一个问题，你可能都很难想到它跟二分查找有关，比如前文 [最长递增子序列](../dong-tai-gui-hua-xi-lie/dong-tai-gui-hua-she-ji-zui-chang-di-zeng-zi-xu-lie.md) 就借助一个纸牌游戏衍生出二分查找解法。
...
在前文 [二分查找详解](../suan-fa-si-wei-xi-lie/er-fen-cha-zhao-xiang-jie.md) 中，详解了如何正确写出三种二分查找算法的细节。二分查找返回目标值 `val` 的索引，对于搜索**左侧边界**的二分查找，有一个特殊性质：
...
[上一篇：一行代码就能解决的算法题](yi-hang-dai-ma-jie-jue-de-zhi-li-ti.md)

[下一篇：Linux的进程、线程、文件描述符是什么](../ji-shu/linux-jin-cheng.md)
