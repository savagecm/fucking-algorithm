...
![jietu](../.gitbook/assets/1%20%281%29.jpg)

但是这时候如果我访问了一下「设置」界面，那么「设置」就会被提前到第一个，变成这样：

![jietu](../.gitbook/assets/2.jpg)

假设我的手机只允许我同时开 3 个应用程序，现在已经满了。那么如果我新开了一个应用「时钟」，就必须关闭一个应用为「时钟」腾出一个位置，关那个呢？

按照 LRU 的策略，就关最底下的「手机管家」，因为那是最久未使用的，然后把新开的应用放到最上面：

![jietu](../.gitbook/assets/3.jpg)
...
[上一篇：二叉堆详解实现优先级队列](../shu-ju-jie-gou-xi-lie/er-cha-dui-xiang-jie-shi-xian-you-xian-ji-dui-lie.md)

[下一篇：二叉搜索树操作集锦](../shu-ju-jie-gou-xi-lie/er-cha-sou-suo-shu-cao-zuo-ji-jin.md)
